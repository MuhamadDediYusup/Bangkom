<div class="form-inline mr-auto">
    ...
    <div class="search-element">
        <form action="{{ route('kompetensiasn.index') }}" method="GET">
            ...
            <input class="form-control" type="search" name="nama_nip" placeholder="Pencarian NIP ASN.." data-width="250"
                autocomplete="off" @cannot('kompetensi-asn-list') disabled @endcannot>
...
<script>
    $(document).ready(function() {
        ...
        $('.dropdown-toggle').attr('aria-hidden', 'false');
    });
</script>
