<aside id="sidebar-wrapper">
    ...
    <div class="px-3 pb-2 hide-sidebar-mini btn-group btn-block btn-icon-split">
        <a href="{{ route('dashboard') }}" class="btn btn-primary" aria-current="page"> <i class="fa fa-file-text-o"
                aria-hidden="true"></i>
            Laporan</a>
        <a href="{{ route('lms.index') }}" class="btn btn-outline-secondary"><i class="fa-solid fa-book-open"></i>
            LMS</a>
    </div>
    ...
    <ul class="sidebar-menu">
        ...
        @can('laporan-list')
        <li
            class="dropdown {{ request()->routeIs('rekapitulasi.index') || request()->routeIs('rekapitulasi.pd') || request()->routeIs('rekapitulasi.asn') || request()->routeIs('rekapitulasi.jenis_diklat') || request()->routeIs('rekapitulasi.waktu') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa-solid fa-calculator"></i>
                <span>Rekapitulasi Laporan</span></a>
            <ul class="dropdown-menu">
                <li class="{{ request()->routeIs('rekapitulasi.pd') ? 'active' : '' }}"><a class="nav-link"
                        href="{{ route('rekapitulasi.pd') }}">Berdasarkan Status</a>
                </li>
                ...
                <li class="{{ request()->routeIs('rekapitulasi.waktu') ? 'active' : '' }}"><a class="nav-link"
                        href="{{ route('rekapitulasi.waktu') }}">Berdasarkan Verifikasi</a>
                </li>
            </ul>
        </li>
        @endcan
        ...
        <li
            class="dropdown {{ request()->routeIs('rekapitulasi.login_terbanyak') || request()->routeIs('rekapitulasi.aktivitas_laporan') || request()->routeIs('rekapitulasi.login_terbaru') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa-solid fa-calculator"></i>
                <span>Aktivitas User</span></a>
            <ul class="dropdown-menu">
                <li class="{{ request()->routeIs('rekapitulasi.login_terbaru') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('rekapitulasi.login_terbaru') }}">Aktivitas
                        Terbaru</a>
                </li>
                <li class="{{ request()->routeIs('rekapitulasi.login_terbanyak') ? 'active' : '' }}"><a class="nav-link"
                        href="{{ route('rekapitulasi.login_terbanyak') }}">Aktivitas
                        Terbanyak</a>
                </li>
                <li class="{{ request()->routeIs('rekapitulasi.aktivitas_laporan') ? 'active' : '' }}"><a
                        class="nav-link" href="{{ route('rekapitulasi.aktivitas_laporan') }}">Aktivitas Laporan</a>
                </li>
            </ul>
        </li>
        @endcan
