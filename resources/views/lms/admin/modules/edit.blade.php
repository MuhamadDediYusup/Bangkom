...
<section class="section">
    <div class="section-body">
        <form action="{{ route('lms.admin.module.update', [$module->module_id]) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="module_chapter" name="module_chapter" class="form-control"
                                    required value="{{ $module->module_chapter }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="estimated_time" name="estimated_time" class="form-control"
                                    required value="{{ $module->estimated_time }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control summernote-simple"
                                    required value="">{{ $module->description }}</textarea>
                                @error('module_name')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
