...
<section class="section">
    <div class="section-body">
        <form action="{{ route('lms.admin.category.update', [$category->category_id]) }}" method="POST"
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="col-auto">
                                        <label class="colorinput">
                                            <input name="color_tag" type="checkbox" value="bg-dark"
                                                class="colorinput-input" {{ $category->color_tag == 'bg-dark' ?
                                            'checked' : '' }} />
                                    ...
                                    <div class="col-auto">
                                        <label class="colorinput">
                                            <input name="color_tag" type="checkbox" value="bg-primary"
                                                class="colorinput-input" {{ $category->color_tag == 'bg-primary' ?
                                            'checked' : '' }} />
                                    ...
                                    <div class="col-auto">
                                        <label class="colorinput">
                                            <input name="color_tag" type="checkbox" value="bg-secondary"
                                                class="colorinput-input" {{ $category->color_tag == 'bg-secondary' ?
                                            'checked' : '' }} />
                                    ...
                                    <div class="col-auto">
                                        <label class="colorinput">
                                            <input name="color_tag" type="checkbox" value="bg-success"
                                                class="colorinput-input" {{ $category->color_tag == 'bg-success' ?
                                            'checked' : '' }} />
                                    ...
                                    <div class="col-auto">
                                        <label class="colorinput">
                                            <input name="color_tag" type="checkbox" value="bg-danger"
                                                class="colorinput-input" {{ $category->color_tag == 'bg-danger' ?
                                            'checked' : '' }} />
                                    ...
                                    <div class="col-auto">
                                        <label class="colorinput">
                                            <input name="color_tag" type="checkbox" value="bg-warning"
                                                class="colorinput-input" {{ $category->color_tag == 'bg-warning' ?
                                            'checked' : '' }} />
                                    ...
                                    <div class="col-auto">
                                        <label class="colorinput">
                                            <input name="color_tag" type="checkbox" value="bg-info"
                                                class="colorinput-input" {{ $category->color_tag == 'bg-info' ?
                                            'checked' : '' }} />
                            ...
                            <button type="submit" class="btn btn-primary">Update Ketegori</button>
                        </div>
                    </div>
                </div>
            </div>
