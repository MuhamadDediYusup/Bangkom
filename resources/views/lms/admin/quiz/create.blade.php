...
<section class="section">
    <div class="section-body">
        <form action="{{ route('lms.admin.quiz.store') }}" method="POST" enctype="multipart/form-data">
            @method('POST')
            @csrf
            <div class="row">
                <div class="col-12">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select id="lesson_id" name="lesson_id" class="form-control">
                                            ...
                                            <option value="{{ $item->lesson_id }}" {{ old('lesson_id')==$item->
                                                lesson_id ? 'selected' : '' }}>{{ $item->lesson_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="description" name="description" class="form-control"
                                            value="{{ old('description') }}" required></input>
                                        @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="passing_score" name="passing_score"
                                            class="form-control" required value="{{ old('passing_score') }}">
                                        @error('passing_score')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="weight_percentage" name="weight_percentage"
                                            class="form-control" required value="{{ old('weight_percentage') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="question_row" name="question_row" class="form-control"
                                            required value="{{ old('question_row') }}">
                                        @error('question_row')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
