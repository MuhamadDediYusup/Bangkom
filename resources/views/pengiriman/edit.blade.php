                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" value="{{ $pengiriman[0]->nama_lengkap }}" readonly
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nip" value="{{ $pengiriman[0]->nip }}" readonly
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="nama_bangkom"
                                        value="{{ $pengiriman[0]->jenis_diklat }},{{ $pengiriman[0]->sub_jenis_diklat }},{{ $pengiriman[0]->rumpun_diklat }},{{ $pengiriman[0]->id_diklat }},{{ $pengiriman[0]->id_siasn }},{{ $pengiriman[0]->sertifikat_siasn }}">
                                    <select class="form-control" name="" disabled>
                                        <option value="">..Pengembangan Kompetensi..</option>
                                        @foreach ($master_diklat->Data as $item)
                                        <option
                                            value="{{ $item->jenis_diklat }},{{ $item->sub_jenis_diklat }},{{ $item->rumpun_diklat }},{{ $item->id_diklat }},{{ $item->id_siasn }},{{ $item->sertifikat_siasn }}"
                                            {{ $item->jenis_diklat == $pengiriman[0]->jenis_diklat &&
                                            $item->sub_jenis_diklat == $pengiriman[0]->sub_jenis_diklat &&
                                            $item->rumpun_diklat == $pengiriman[0]->rumpun_diklat
                                            ? 'selected'
                                            : '' }}>
                                            {{ $item->jenis_diklat }} -
                                    ...
                                    <input type="hidden" name="id_usul" value="{{ $pengiriman[0]->id_usul }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Nama Diklat <span class="text-danger">*</span></label>
                                    <input name="nama_diklat" type="text"
                                        value="{{ strip_tags($pengiriman[0]->nama_diklat) }}" class="form-control @error('nama_diklat')
                                        is-invalid
                                        @enderror">
                                    @error('nama_diklat')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="search" name="tempat_diklat"
                                        value="{{ $pengiriman[0]->tempat_diklat }}" placeholder="..Tempat Bang Kom.."
                                        class="form-control @error('tempat_diklat')
                                        is-invalid
                                        @enderror" required>
                                    @error('tempat_diklat')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="search" name="penyelenggara_diklat"
                                        value="{{ $pengiriman[0]->penyelenggara_diklat }}"
                                        placeholder="..Penyelenggara Bang Kom.."
                                        class="form-control @error('penyelenggara_diklat') is-invalid @enderror"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_mulai"
                                        value="{{ strip_tags($pengiriman[0]->tgl_mulai) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_selesai"
                                        value="{{ strip_tags($pengiriman[0]->tgl_selesai) }}" class="form-control @error('tgl_selesai')
                                        is-invalid
                                        @enderror" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="search" name="nomor_surat"
                                        value="{{ strip_tags($pengiriman[0]->nomor_surat) }}"
                                        placeholder="..Nomor Surat.." class="form-control @error('nomor_surat')
                                        is-invalid
                                        @enderror" required>
                                    @error('nomor_surat')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_surat"
                                        value="{{ strip_tags($pengiriman[0]->tgl_surat) }}" class="form-control @error('tgl_surat')
                                        is-invalid
                                        @enderror">
                                    @error('tgl_surat')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file mb-3 custom-input-pdf">
                                        <input type="file" class="custom-file-input @error('file_spt')
                                        is-invalid
                                        @enderror" name="file_spt" id="customFileSPT"
